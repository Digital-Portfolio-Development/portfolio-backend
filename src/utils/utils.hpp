...
using ProjectTuple =
    std::tuple<int, int, std::string, std::string, std::string, std::string,
               ...
               bool, int, userver::storages::postgres::TimePointTz,
               std::optional<userver::storages::postgres::TimePointTz>,
               std::string, std::optional<std::string> >;
using PostTuple =
    std::tuple<int, int, std::string, std::string, std::optional<std::string>,
...
using CommentTuple =
    std::tuple<int, int, int, std::string, std::string,
               ...
               std::optional<userver::storages::postgres::TimePointTz>,
               std::string, std::optional<std::string> >;
using LikeTuple = std::tuple<int, int, std::string, std::string,
                             userver::storages::postgres::TimePointTz>;
...
template <class... T>
std::string ParseRequestData(const userver::formats::json::Value& request,
                             T&&... args) {
...
std::string ValidateRequestData(const std::string& key,
                                userver::formats::json::Value&& value_json,
                                std::size_t len, bool is_email = false);

userver::formats::json::Value ResponseMessage(const std::string& message);
}  // namespace portfolio::utils
